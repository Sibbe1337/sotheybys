...
const staffMembers = [
  ...
  },
  {
    id: '3',
    name: 'Eeva Kyläkoski',
    title: 'Senior Rådgivare - Styrelsemedlem, LKV',
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="privacy-staff-sv" className="text-sm font-light text-gray-700">
                    Jag har läst och godkänner <a href="#" className="text-[var(--color-primary)] underline">integritetspolicyn</a>
                  </label>
                </div>
                ...
                <div className="text-center">
                  <p className="text-xs font-light text-gray-600 mb-4">
                    ...
                    <a href="#" className="text-[var(--color-primary)] underline">integritetspolicy</a> och{' '}
                    <a href="#" className="text-[var(--color-primary)] underline">användarvillkor</a> gäller.
                  </p>
                  <button
                    type="submit"
