              ...
              <div className="max-w-4xl mx-auto mb-8">
                <div className="relative bg-[#2a2a2a] rounded-lg overflow-hidden" style={{ paddingBottom: '40%' }}>
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <p className="text-white text-lg">Den här videon är privat</p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-[1400px] mx-auto px-6">
            ...
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <p className="text-xl text-gray-700 font-light leading-relaxed mb-12">
                Vår klient, det vill säga köparen, betalar full provision. Har du funderat på att sälja ditt hem?
              </p>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <p className="text-center text-lg text-gray-700 font-light mb-12">
                Om du har några frågor kan du alltid kontakta oss via telefon, e-post eller genom att besöka vårt kontor!
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <h2 className="text-3xl lg:text-4xl font-light mb-6">
                  Vårt Helsingforskontor
                </h2>
                <p className="text-lg font-light leading-relaxed mb-8 text-white/90">
                  År 2015 började en ny era i Finland. Ab Snellman LKV Oy Sotheby's International Realty öppnade sina dörrar för den finska marknaden med mål att lyfta fastighetsmäkleri till en helt ny nivå. I kontoret, beläget i den dynamiska huvudstaden Helsingfors, väntar ett motiverat team av experter redo att göra din dröm till verklighet. Kontoret kan vara beläget i södra Finland men vår försäljning och verksamhet täcker hela landet. Från den vackra skärgården upp till förtrollande Lappland och allt däremellan.
                </p>
                <Link
