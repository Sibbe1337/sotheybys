...
const translations = {
  ...
  sv: {
    ...
    mainText: 'Vår kund betalar förmedlingsprovisionen. Har ni övervägt en försäljning av er bostad?',
    contactText: 'Om du har några frågor kan du alltid kontakta oss genom att ringa, skicka ett email eller med att besöka vårt kontor!',
  ...
  en: {
    ...
    ctaBtn: 'SEE CURRENT PURCHASE MANDATES »',
    mainTitle: 'Purchase Mandates',
    mainText: 'Our client, ie the buyer, pays the full commission. Have you considered selling your home?',
    contactText: 'If you have any questions, you can always contact us by calling, sending an email or stopping by our office!',
