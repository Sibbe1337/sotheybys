              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="privacy-staff-en" className="text-sm font-light text-gray-700">
                    I have read and accept the <a href="#" className="text-[var(--color-primary)] underline">Privacy Policy</a>
                  </label>
                </div>
                ...
                <div className="text-center">
                  <p className="text-xs font-light text-gray-600 mb-4">
                    ...
                    <a href="#" className="text-[var(--color-primary)] underline">Privacy Policy</a> and{' '}
                    <a href="#" className="text-[var(--color-primary)] underline">Terms of Service</a> apply.
                  </p>
                  <button
                    type="submit"
