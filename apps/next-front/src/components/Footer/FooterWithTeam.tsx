...
export default function FooterWithTeam() {
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="pt-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="inline-block bg-white/10 rounded-lg p-3">
                      <Image 
                        src="/images/logos/logo-white.png"
                        alt="Suomen Kiinteistönvälittäjäliitto"
                        width={60}
                        height={60}
                        className="opacity-70"
                      />
                ...
                <div className="flex items-center space-x-4 pt-4">
                  <Link href="https://www.facebook.com/Snellmansothebysrealty/" 
                        target="_blank" 
                  ...
                  <Link href="https://www.instagram.com/sothebysrealtyfinland" 
                        target="_blank" 
                        rel="noopener noreferrer"
                  ...
                  <Link href="https://www.youtube.com/channel/UCUDafZp-yXwW6d-amvxoebQ" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        aria-label="YouTube" 
                        className="text-white/60 hover:text-[var(--color-gold)] transition-colors">
                  ...
                  <Link href="https://se.pinterest.com/sothebysrealtyfinland/" 
                        target="_blank" 
                        rel="noopener noreferrer"
                  ...
                  <Link href="https://www.linkedin.com/company/snellman-sothebys-international-realty" 
                        target="_blank" 
                        rel="noopener noreferrer"
                        aria-label="LinkedIn" 
                        className="text-white/60 hover:text-[var(--color-gold)] transition-colors">
      ...
      <div className="bg-[#000e1f] text-white py-6">
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4">
            ...
            <p className="text-xs text-white/60 max-w-5xl mx-auto leading-relaxed font-light">
