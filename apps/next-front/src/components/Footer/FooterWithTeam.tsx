      ...
      <div className="bg-[#001731] text-white">
        <div className="container mx-auto px-4 py-12 pb-16 lg:pb-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-white font-bold">
                    {contactInfo.address && (
                      ...
                      >
                        {/* House icon - matching old design */}
                    ...
                    {contactInfo.phone && (
                      <a 
                        ...
                        className="flex items-center gap-2 hover:text-[var(--color-gold)] transition-colors"
                      >
                        {/* Phone handset icon - matching old design */}
                        <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {contactInfo.email && (
                      <a 
                        ...
                        className="flex items-center gap-2 hover:text-[var(--color-gold)] transition-colors"
                      >
                        {/* Envelope icon - matching old design */}
                        <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="flex items-center gap-2">
                      {/* Scales/Balance icon for Y-tunnus - matching old design */}
                      <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-end justify-center lg:justify-start overflow-hidden lg:overflow-visible">
              <div className="relative h-[350px] lg:h-[450px] w-[100%] lg:w-[90%] overflow-hidden lg:overflow-visible group">
                <Image
