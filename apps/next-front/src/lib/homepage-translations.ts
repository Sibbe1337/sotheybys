...
export const HOMEPAGE_TRANSLATIONS: HomepageTranslations = {
  ...
  hero1Subtitle: {
    fi: '26 000 välittäjää 1 100 välitystoimistossa 86 maassa ja alueella',
    sv: '26 000 mäklare i 1 100 kontor i 86 länder och regioner',
    en: '26,000 Sales Associates in 1,100 Offices in 86 Countries & Territories'
  },
  hero1Button: {
    fi: 'Avaamme uusia ovia',
    sv: 'Vi öppnar nya dörrar',
